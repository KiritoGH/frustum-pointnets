...
def test_from_rgb_detection(output_filename, result_dir=None):
    ...
    for batch_idx in range(num_batches):
        ...
        batch_data, batch_rot_angle, batch_rgb_prob, batch_one_hot_vec = \
            get_batch(TEST_DATASET, test_idxs, start_idx, end_idx, NUM_POINT, NUM_CHANNEL, from_rgb_detection=True)
        ...
        batch_sclass_pred, batch_sres_pred, batch_scores = inference(sess, ops, batch_data_to_feed,
